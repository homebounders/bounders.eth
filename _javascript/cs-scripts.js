...
window.addEventListener("scroll", function(){
     ...
     clouds1.style.top = value * .85 + "px";
     ceiling.style.top = -200 + value * .75 + "px";
     clouds2.style.top = value * .65 + "px";
     town1.style.top = value * .5 + "px";
     town2.style.top = value * .15 + "px";
     boat.style.top = value * -.03 + "px";
     deck.style.top = value * -.05 + "px";
})
...
//Song Titles
const songs = ['01 Cali Bay Area Love', '02 Chinatown', '03 Carnage', '04 Feel Good', '05 For The F', '06 Giggin', '07 Kss Kss', '08 On Tha Real', '09 Underground', '10 Something U Said', '11 Stoopid', '12 Summerz', '13 Fly', '14 Tenderloins', '15 Ese Ose', '16 Release', '17 Despierto', '18 He7vn', '19 Zombi', '20 Mercury Theme', '21 Salt Theme', '22 Tarzan Boy Remake']
...
function playSong() {
  ...
  if (img.src.match(/play\.png$/)) { // if the image is currently the play button
...
function pauseSong() {
  ...
  if (img.src.match(/pause\.png$/)) { // if the image is currently the play button
